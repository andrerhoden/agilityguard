...
@section('content')
  ...
  <section class="masthead white-bg">
      ...
      <section class="white-bg">
        ...
        <div class="row">
          <img  width="100%" height="100%" src="http://www.agilityguard.com/assets/images/sports/sport_banner_basketball.jpg">
        </div>
...
<p>Explosive power, particularly in your vertical jump, is key to you. This requires that you be strong. &nbsp;And every little bit helps. With Triumphant on your team, you’ll have an immediate advantage over your opponent from training day straight through to game day. </p>

<h2>Speed and Acceleration</h2>
<p>Calling upon your body to get away, and stay ahead, of your opponents gives you an edge. Accelerating, reacting, and competing faster than before. Improve your overall speed and reaction time and you’ll improve the way you play. AgilityGuard™ gives you the explosive edge you’ve always wanted.</p>
<h2>Balance</h2>
<p>Solid footwork depends on balance. When ball-handling, rebounding, blocking or defending, or attacking your opponents' net, it is crucial that you be able to maintain your balance and maintain control. With better balance you’ll step when you want to step, move when you want to move and stand your ground when it counts the most. Improved balance and alignment can mean increased accuracy, and a more consistent, centred performance.  </p>
<h2>Agility</h2>
<p>Being more agile means staying light on your toes and ready to make your move. Explode from a stand still, stop on a dime and take your game to a whole new level with a little help from AgilityGuard™. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   </p>
<h2>Endurance and Recovery</h2>
<p>Your ability to play longer, run harder and increase your tolerance to take more pain gives you an advantage. With help from AgilityGuard™ you may be able to train harder, recover faster and improve your performance where it counts.  </p>
<p>We do not have empirical evidence to support enhanced endurance and recovery, but have been told by users that they have found that they have better endurance and recover more quickly. These are areas that we would want to pursue for empirical evidence.</p>
