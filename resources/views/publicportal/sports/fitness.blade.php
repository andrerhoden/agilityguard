        ...
        <div class="container">
          <div class="row">
            ...
            <div class="clearfix" id="body_content_left" style="min-height:1000px;">
              ...
              <div>
              <p class="t_quote">"I began using the AgilityGuard in the beginning of the season and immediately noticed benefits in performance across the board - endurance, strength, speed, breathing, center of gravity. I raced with the mouthpiece and won. The next training block, I thought I'd train without it. Suddenly, my results and performances plateaud.  After a terrible performance racing without it, I went back to AgilityGuard and noticed that everything began to improve once again.  The AgilityGuard is essential"</p>
              <p class="t_name">Matt Chabrot</p>
              <p class="t_title">#1 Ranked USA Triathlete, 2010 USAT ITU/Olympic Athlete of the Year, 2009 USAT Elite National Champion, 2009 Huatulco ITU World Cup Champion</p>
              </div>
              <div class="clearfix"></div>
              </div>

              <div class="tes">
              <img src="/images/testimonials/mark.jpg">
              <div>
              ...
              <p class="t_name">Mark Fretta</p>
              <p class="t_title">Former World Number 1 Tri-Athlete, 2010 Chicago Triathlon Champion</p>
              </div>
              <div class="clearfix"></div>
              </div>

              <div class="tes"><p><img src="/assets/images/system/images/0000/2236/Paul_Romero_-_Testimonial_medium.png" title="Paul Romero   Testimonial" alt="Paul Romero   Testimonial" rel="medium">
              </p>
              <div>
              <p class="t_quote">"As an elite endurance athlete, you get to know your body and mind pretty well. As I began the 4 day adventure race in Chile, I was not sure what to expect with AgilityGuard. What came about during a 10.5 hour run on day 3, then a 5 hour run on day 4 was something I can hardly explain. With AgilityGuard, we ran fast, we glided and we leaped for 10 hours to a resounding victory."</p>
              <p class="t_name">Paul Romero&nbsp;</p>
              <p class="t_title">Elite Endurance/Adventure Racing, Mt. Everest Summiteer</p>
              </div>
              <div class="clearfix"></div>
              </div>

              <div class="tes"><p><img src="/assets/images/system/images/0000/2245/Slater_Fletcher_-_Testimonial_medium.png" title="Slater Fletcher   Testimonial" alt="Slater Fletcher   Testimonial" rel="medium">
              </p>
              <div>
              <p class="t_quote">&nbsp;"Real life field tested over 20 hours of adventure running with a heavy pack..it WORKS! &nbsp;I can honestly say I am at a lifetime best fitness right now and I believe the AgilityGuard has alot to do with that.&nbsp; 
              </p>
              <p class="t_quote">I have used it for almost every swim session in the last 8 weeks and swimming is where I have made the most improvement.  Breathing with it is no different for me if I am using it. I have noticed when swimming that my neck and shoulders are much more relaxed and my core is aligned from head to toe which helps my body position in the water.  I am swimming faster but the biggest difference is that I can hold my relative speed for much, much longer.  That is specific to the nature of long course triathlon swimming! On long rides or runs I take out the AG when I need to eat.  No time lost and I have done many sessions over 8hrs like this without dropping it or having issues eating or drinking."&nbsp;
              </p>
              <p class="t_name">Slater Fletcher</p>
              <p class="t_title">Ironman, Elite Endurance/Adventure Racing</p>
              </div>
              <div class="clearfix"></div>
              </div>


              <p><img src="/assets/images/system/images/0000/1066/TAG-MarkF-Cornerbrook_03_medium.jpg" title="Tag Mark F Cornerbrook 03" alt="Tag Mark F Cornerbrook 03" rel="medium">Mark Fretta, former world number 1-ranked triathlete and winner of the recent Chicago TriAthlon, is an AgilityGuard user. Mark provides the following feedback:"Triathlon is a sport of many elements. In order to reach the peak of performance in the sport, one must develop quickness, endurance, power, speed, and technique in the three disciplines of swimming, cycling, and running. Additionally, to reach the elite levels of triathlon, one must find a way to maximize fitness and performance daily. To do so, an athlete must constantly find ways to improve upon weaknesses and continue to train and develop strengths. After several years of developing and maintaining my peak form in the sport of triathlon, I have finally found a unique product that has made a substantial difference in both my training and my performance."</p>
              <p><img src="/assets/images/system/images/0000/1057/TAG-MarkF-Chicago_2_medium.jpg" title="Tag Mark F Chicago 2" alt="Tag Mark F Chicago 2" rel="medium">"The AgilityGuard has had an extremely noticeable and positive effect on my abilities as a triathlete. Proper placement of my bite during my training, especially in the weight room and on my bike, has created an immediate increase in both my short-term and prolonged power outputs. Additionally, this increased strength has directly translated to greater speed on my run, a better power-to-weight ratio on my bike, and prolonged muscular endurance evident in my swim, bike, and run.</p>
